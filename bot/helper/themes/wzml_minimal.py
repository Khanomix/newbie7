...
class WZMLStyle:
    ...
    ST_BN1_NAME = 'made by'
    ST_BN1_URL = 'https://t.me/BarneyStn'
    ST_BN2_NAME = 'channel'
    ST_BN2_URL = 'https://t.me/Nimleecher'
    ST_MSG = '''<i>تبدیل فایل تلگرامی|لینک|تورنت|یوتیوب به لینک مستقیم نیم بها.</i>
<b>Type {help_command} to get a list of available commands</b>'''
    ST_BOTPM = '''<i>Now, This bot will send all your files and links here. Start Using ...</i>'''
    ST_UNAUTH = '''<i>ah...hm...ok</i>'''
